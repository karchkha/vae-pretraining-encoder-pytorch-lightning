...
##############################################################################################################
    ...
    def train_dataloader(self):
        ...
        train_data = MonoTextData(self.args.train_data, label=self.args.label)
    
        self.len_train_data = len(train_data)
        self.vocab = train_data.vocab
        ...
        train_data_batch =train_data.create_data_batch(batch_size=self.args.batch_size,
                                                device="cpu",
                                                batch_first=True)
                                                
        loader = DataLoader(train_data_batch, batch_size=None, num_workers=self.args.workers, shuffle=True) #, pin_memory=True) 
    ...
    def val_dataloader(self):
        ...
        val_data = MonoTextData(self.args.val_data, label=self.args.label, vocab=self.vocab)
    

        val_data_batch =val_data.create_data_batch(batch_size=self.args.batch_size,
                                                device="cpu",
                                                batch_first=True)
                                                
        loader =  DataLoader(val_data_batch, batch_size=None, num_workers=self.args.workers) #, pin_memory=True)
        
        self.len_val_data = len(loader)
    ...
    def test_dataloader(self):
        ...
        # print()
        loader =  DataLoader(test_data_batch, batch_size=None, num_workers=self.args.workers) #, pin_memory=True) #, pin_memory=True, pin_memory_device = self.args.device)
